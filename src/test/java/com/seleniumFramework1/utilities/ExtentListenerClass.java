...
public class ExtentListenerClass implements ITestListener {
	...
	public void configureReport() {
		...
		reports.setSystemInfo("user name:", "arshad");
	...
	// OnStart method is called when any Test starts.(executed only once)
	public void onStart(ITestContext Result) {
		configureReport();
		System.out.println("On Start method invoked....");
	}

	// onFinish method is called after all Tests are executed(executed only once)
